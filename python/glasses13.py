...
def setup(): 
  ...
  command("8:zon:red:flo")
  command("9:zon:blu:flo")                                       
  command("10:zon:grn:blk:2:cpy")                                       
  command("11:zon:org:flo")                                       

  command("1:zon:pur:flo")
  command("4:zon:dgr:flo")

  # preload the carry buffer
  command("grn")
...
def loop():
  command("0:rev:2:zon:car:1:rev:3:zon:car")
  command("0:rev:1:zon:car:1:rev:4:zon:car:flu")                         
