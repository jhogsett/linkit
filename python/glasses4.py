...
def setup(): 
  ...
  command("1:zon:blk:grn:blk:grn:blk:pur:blk:pur")
  command("2:zon:blk:red:2,5:cpy")
  command("8:zon:blk:blu:2,5:cpy")
  command("3:zon:blk:blu:2,5:cpy")
  command("9:zon:blk:red:2,5:cpy")
  command("1:rev:12:rot:0:rev")
  command("4:zon:pur:blk:pur:blk:grn:blk:grn:blk")
