...
########################################################################
  if group("sequencing"):                                                                                                            
    ...
    if test("it does a wheel sequence in reverse"):
      expect_buffer("0,7,1:seq:red:flu", 0, 2, "20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:org", 0, 5,       "20,10,0,20,10,0,20,10,0,20,10,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:yel", 0, 8,       "20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:grn", 0, 12,      "0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:blu", 0, 16,      "0,0,20,0,0,20,0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:pur", 0, 17,      "10,0,20,0,0,20,0,0,20,0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:red", 0, 23,      "20,0,0,20,0,0,20,0,0,20,0,0,20,0,0,20,0,0,10,0,20,0,0,20,0,0,20,0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)

    if test("it does a swing sequence in reverse"):
      expect_buffer("0,7,1:sqs:red:flu", 0, 2, "20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:org", 0, 7,       "20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:yel", 0, 11,      "20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:grn", 0, 14,      "0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:blu", 0, 16,      "0,0,20,0,0,20,0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:pur", 0, 17,      "10,0,20,0,0,20,0,0,20,0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
      expect_buffer("0,-2:seq:red", 0, 19,      "20,0,0,20,0,0,10,0,20,0,0,20,0,0,20,0,20,0,0,20,0,0,20,0,20,20,0,20,20,0,20,20,0,20,20,0,20,10,0,20,10,0,20,10,0,20,10,0,20,10,0,20,0,0,0,0,0", True, True)
