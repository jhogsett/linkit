...
const char cmd_103[] PROGMEM = "fan";
const char cmd_104[] PROGMEM = "mth"; // accumulator manipulation
const char cmd_105[] PROGMEM = "pso";
...
const char* const command_strings[] PROGMEM = {
   ...
   cmd_101, cmd_102, cmd_103, cmd_104, cmd_105
};
