...
#define CMD_KEY         104 // get keyboard key

#define CMD_TONE        105
#define CMD_RETURN_IF   106
...
const char cmd_104[] PROGMEM = "key"; // keyboard handling
const char cmd_105[] PROGMEM = "ton"; // tone
const char cmd_106[] PROGMEM = "rif"; // return-if
